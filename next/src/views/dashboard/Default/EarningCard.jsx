        ...
        >
          <Box sx={{ p: 2.25 }}>
            <Stack direction="row" sx={{ justifyContent: 'space-between' }}>
              <Avatar variant="rounded" sx={{ bgcolor: 'secondary.darker', mt: 1 }}>
                <CardMedia sx={{ width: 28, height: 28 }} component="img" src={EarningIcon} alt="Notification" />
              </Avatar>
              <Avatar
                variant="rounded"
                sx={{ bgcolor: 'secondary.dark', color: 'secondary.light', zIndex: 1, cursor: 'pointer' }}
            ...
            <Typography sx={{ mb: 1.25, fontSize: '1rem', fontWeight: 500, color: 'secondary.light' }}>Total Earning</Typography>
          </Box>
        </MainCard>
      )}
    </>
