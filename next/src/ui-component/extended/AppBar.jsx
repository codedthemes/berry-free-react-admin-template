...
function ElevationScroll({ children, window }) {
  ...
  return cloneElement(children, {
    ...
    style: {
      backgroundColor: trigger ? theme.vars.palette.dark[800] : theme.vars.palette.background.default,
      ...
      <MuiAppBar>
        <Container>
          <Toolbar sx={{ py: 2.5, px: `0 !important` }}>
            <Typography component={RouterLink} href="/" sx={{ flexGrow: 1, textAlign: 'left' }}>
              <Logo />
            </Typography>
            <Stack direction="row" sx={{ gap: { xs: 1.5, md: 2.5 }, display: { xs: 'none', sm: 'flex' } }}>
              ...
              <Button color="inherit" component={RouterLink} href="/login" target="_blank" nativeButton={false}>
                Dashboard
              </Button>
